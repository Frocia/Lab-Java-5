# Лабораторная работа: Решение задач на Java 5

## Описание проекта

Проект содержит решения 8 задач, реализованных в отдельных классах на Java. Каждое задание демонстрирует различные аспекты программирования: работа с файлами, обработка данных, использование Stream API, ООП и алгоритмы.
